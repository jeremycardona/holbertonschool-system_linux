...
/**
 * psh32 - prints 32 bit section headers
 * @elf_header: address of elf header struct
 * @string_table: the string table section
 */
void psh32(elf_t *elf_header, char *string_table)
{
    size_t i = 0;
...
/**
 * psh64 - prints 64 bit section headers
 * @elf_header: address of elf header struct
 * @string_table: the string table section
 */
void psh64(elf_t *elf_header, char *string_table)
{
    size_t i = 0;
...
/**
 * gsf - translates section flags to string
 * @elf_header: address of elf header struct
 * @i: the section index
 * Return: legend-based string rep of flag
 */
char *gsf(elf_t *elf_header, size_t i)
{
    static char buf[32];
